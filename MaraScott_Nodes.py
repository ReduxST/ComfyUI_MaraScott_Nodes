...
# from .py.nodes.Segmentor.YoloDetection_v1 import YoloDetection_v1 # good code example for automatic download of models
...
NODE_CLASS_MAPPINGS = {
    ...
    # "MaraScott_YoloDetection_v1": YoloDetection_v1,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    # "MaraScott_YoloDetection_v1": "\ud83d\udc30 Yolo Detection v1 /v",
